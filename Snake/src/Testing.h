...
#define EGG 254 //n?ero 6
#define SNAKE 178 //n?ero 1,2,3,4
#define SNAKE_HEAD 219 //cabe? da cobra
#define BORDER '#' //n?ero 5
#define BLANK ' ' //n?ero 0
#define MAP_WIDTH 80
#define MAP_HEIGHT 20
#define START_POINT 7
#define START_LENGTH 4
#define DELAY_TIME 30000000 //n?ero de ciclos de delay
struct coordenada {
	int x;
	int y;
};
...
maxlength, //comprimento m?imo da cobra
score;
coord egg,
snakeStartPos, //cabe?
...
int verifyHeadUp(); //verifica se ?o final da cauda
int verifyHeadDown();	//
int verifyHeadRight(); //
int verifyHeadLeft();	//
void moveHeadUp(); //move a cabe? da cobra
void moveHeadDown();	//
void moveHeadRight();	//
void moveHeadLeft();	//
